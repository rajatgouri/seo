  ...
  return (
    <>
      <div className="flex justify-between">
        ...
        <button className="bg-dark text-white px-3 py-1 rounded-md transition hover:bg-indigo-900 focus:outline-none transition sm:px-1 sm:py-0" onClick={()=> setOpen(!open)}>
